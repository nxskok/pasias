...
`r tufte::margin_note("The very   negative residuals are at the left and right of the residual plot;  they are there because the relationship is a curve. If you were to  look at the residuals from the model with length-squared, you  probably wouldn't see this.")`

Another plot you can make is to assess fan-out: you plot the
*absolute value*
`r tufte::margin_note("The value, but throw away the minus sign if it has one.")` of the residuals against the fitted values. The idea
