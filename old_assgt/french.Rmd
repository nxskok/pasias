...
\p Explain briefly why this is a matched-pairs study. 
...
\p Run a suitable matched-pairs $t$-test to see whether the teachers' scores have on average *improved* over the four weeks.
...
\p What do you conclude from your test, in the context of the data?
...
\p How much is the teachers' listening skill improving, on average? Give a suitable interval to support your answer.
...
\p Make a suitable plot to assess any assumptions for this test.
...
\p Do you trust the result of your matched-pairs $t$-test? Explain briefly. 
...
\p Run a suitable sign test, and obtain a suitable (95%) confidence interval. Comment briefly on your results.
