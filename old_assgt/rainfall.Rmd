\question In 1997, a company in Davis, California, had problems with
...
don't start in the same place, that is probably aligned columns. 
  ...
  \p Summarize the data frame (as done in Lecture 2).
...
```
  ...
  \p Make a suitable plot of the rainfall values. (We are not,
...
\p How would you describe the shape of the distribution of
  rainfall values?
...
This will depend on the histogram you drew in the previous
  ...
  \p In the quote at the beginning of the question, where do you
...
level was the \emph{median}.
 ...
 \eS
   ...
   \p Do you think the official's calculation was reasonable? 
