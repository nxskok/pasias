...
\question The General Social Survey is a large survey of a large number of people. One of the questions on the survey is "how many hours of TV do you watch in a typical day?" Another is "what is your highest level of education attained", on this scale:
...
Do people with more education tend to watch more TV? We will be exploring this. The data are in \url{http://ritsokiguess.site/datafiles/STAC32/gss_tv.csv}.
...
```{r}
my_url <- "http://ritsokiguess.site/datafiles/STAC32/gss_tv.csv"
gss <- read_csv(my_url)
gss
```
...
\p[3] For each level of education, obtain the number of observations, the mean and the median of the number of hours of TV watched.
...
\p[2] What does your answer to the previous part tell you about the shapes of the distributions of the numbers of hours of TV watched? Explain briefly. 
...
\p[2] Obtain a suitable graph of your data frame.
...
\p[2] Does your plot indicate that your guess about the distribution shape was correct? Explain briefly.
...
\p[2] Run a suitable test to compare the average number of hours of TV watched for people with each amount of education. ("Average" could be mean or median, whichever you think is appropriate.)
...
\p[2] What do you conclude from your test, in the context of the data?
...
\p[3] Why might you now want to run some kind of follow-up test? Run the appropriate thing and explain briefly what you conclude from it, in the context of the data.
