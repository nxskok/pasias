...
```{r}
my_url <- "http://ritsokiguess.site/datafiles/STAC33/algebra.txt"
...
\p Make a suitable graph of these data.
...
\p Comment briefly on your graph, thinking about what the teachers would like to know.
...
\p Work out the median and  inter-quartile range for the students who did and who did not have laptops, and compare with the boxplot. (In R, the inter-quartile range is `IQR` in uppercase.)
