...
```     
  ...
  \p Make a suitable graph of the two columns.
...
```     
  ...
  \p Run a suitable two-sample $t$-test to address the question
...
average handspans than females.
  ...
  \p Obtain a 90\% confidence interval for the difference
...
Thus, getting the output alone is only one out of three things.
  ...
  \p Explain briefly why you might have some concerns about the
