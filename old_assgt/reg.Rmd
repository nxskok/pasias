\question Earlier, we investigated some data on predicting the height of a person from the length of their foot. The data were in \url{http://ritsokiguess.site/datafiles/STAC32/heightfoot.csv}.
...
\p In STAC67, you learn (or will learn) the matrix formulation of the least squares estimates of intercept and slope. This produces a vector $\hat\beta$ containing estimates of both the intercept and the slope, from the formula
...
\p Verify that your calculation is correct by running the regression.
