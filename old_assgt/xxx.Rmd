...
(a)[2] Read in and display (some of) the data.
...
(a) Make a suitable plot of your dataframe.
...
(a)[3] Obtain a 95% confidence interval for the mean diameter.
...
(a)[4] Based on what you have seen so far, would you expect to reject a null hypothesis that the population mean diameter (of all longleaf pines like these) is 35 cm? Explain briefly. Then, carry out the test (against a two-sided alternative) and explain briefly whether you were right.
...
(a)[3] Would you expect 35 cm to be in a *99%* confidence interval for the mean diameter? Explain briefly, and then see if you were right.
