...
```     
  ...
  (a) Make a suitable graph of the two columns.
...
```     
  ...
  (a) Run a suitable two-sample $t$-test to address the question
...
average handspans than females.
  ...
  (a) Obtain a 90\% confidence interval for the difference
...
Thus, getting the output alone is only one out of three things.
  ...
  (a) Explain briefly why you might have some concerns about the
