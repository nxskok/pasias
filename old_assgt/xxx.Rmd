...
(a) Display only the two columns `mercury` and `sex`.
...
(a) Display all the columns whose names have exactly three characters, without naming any columns.
...
(a) Display only the mercury levels for the females. 
...
(a) What is the mean mercury concentration for all the dolphins whose age is less than 15?
...
(a) What is the mean mercury concentration for all  the dolphins whose age is greater than 25?
...
(a) Make a suitable graph of these data (all three columns).
...
(a) Explain briefly how your graph and your calculations of mean mercury concentration are telling a similar story.
