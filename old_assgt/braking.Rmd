...
Data were collected for a typical car and driver, as shown in \url{http://ritsokiguess.site/datafiles/STAC32/stopping.csv}. These are American data, so the speeds are miles per hour and the stopping distances are in feet.
