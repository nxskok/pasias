...
First, save them (my preference is under plural names):
...
Step 3 is to do the predictions. Into `predictions` go (in order)
the fitted model and the new data frame that we just made:
