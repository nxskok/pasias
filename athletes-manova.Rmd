...
(a)[2] Read in the data and verify that you have 202 rows and 13
columns. 
...
(b)[2] We are going to see whether the height-weight combination
...
(c)[2] Create a response variable for a MANOVA. (You don't need to
...
(d)[3] Run a multivariate analysis of variance to see whether the
...
(e)[3] Briefly justify removing the interaction term from your
...
or, with \textrm{Manova}, the same two ways:
...
(f)[3] See if you can make a graph that shows what's going on
