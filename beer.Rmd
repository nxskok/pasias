...
(h) Obtain a K-means
clustering
`r tufte::margin_note("If we haven't done this in class yet, skip the      rest of the question, and the following question, for now and      come back to it next week.")` with 2 clusters. 
