...
Extra: another way to assess this is with a Shepard^[This always makes me think of the number 190 (now 985) bus, but that's the wrong spelling. Spelled like this, this is also the name of the illustrator of the original pre-Disney Winnie-the-Pooh stories. See `https://en.wikipedia.org/wiki/E._H._Shepard`.]
