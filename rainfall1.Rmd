...
happened or existed in the past". `r tufte::margin_note("Searching for define followed by a word is a good way to find out exactly what that word means, if you are not sure, but you should at least say where you got the definition from if you had to look it up.")` 
