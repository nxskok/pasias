...
`r tufte::margin_note("If you ignore the wind gust, anyway.")`
...
`r tufte::margin_note("There are also options to keep the original variables, and give the new ones new names.")`
