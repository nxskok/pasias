...
model.
`r tufte::margin_note("The suspicion being that we can, since the    scatterplot suggested serious non-linearity.")`
...
`r tufte::margin_note("Again, not a surprise, given our  initial scatterplot.")` 
...
`r tufte::margin_note("Now we can use that word   *significant*.")` 
