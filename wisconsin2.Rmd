...
`r tufte::margin_note("I knew this existed, but I couldn't remember what it was called, which made it hard to search for. My first port of call was na-if, which converts values to NA, the opposite of what I wanted. But from See Also I got na-replace, and from the See Also of that, I found out what coalesce does.")`
