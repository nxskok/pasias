...
I am taking the point of view that we want to compare ratings within each category of `home`, which I think makes sense here (see discussion below), which breaks my "rule" that the categorical variable with fewer categories should be `x`. `r tufte::margin_note("Perhaps a better word here would be principle, to convey the idea that you can do something else if it works better for your purposes.")` 
