...
`r tufte::margin_note("SAS, for example, has a way of making non-orthogonal contrasts orthogonal in a way that the user doesn't have to worry about, but in R, you are closer to the ground, so to speak, and you have to make it happen yourself.")`

The best
description I have seen of what to do here is by David Howell
`r tufte::margin_note("Howell is the author of a famous text on Statistics in Psychology.")`, at
