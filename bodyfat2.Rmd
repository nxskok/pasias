...
`r tufte::margin_note("My hat stays on my head.")` There
...
of the Rings
`r tufte::margin_note("The movies of Lord of the Rings were filmed      in New Zealand, which is also the country in which R was first      designed.")` --- put all the fat measurements in one column with a
