...
varieties of Heliconia: \textsl{bihai}, \textsl{caribaea} red, and
\textsl{caribaea} yellow.
...
\textsl{Caribaea} red (note that the variable name in the data
...
\textsl{Caribaea} yellow (this also has an underscore in it).
...
line. To my mind, this is clearly the last one, \textsl{Caribaea}
yellow. So your answer ought to be ``\textsl{Caribaea} yellow,
...
Let's look at \textsl{bihai} first. I see this one as an almost
...
on how you look.
We also had to look at the second plot, \textsl{caribaea}
...
different. \textsl{Caribaea} yellow is more or less straight,
\textsl{bihai}  has outliers (and may also be curved), \textsl{caribaea}
...
\textsl{caribaea} yellow is shoulder-shruggingly normal (I looked at
