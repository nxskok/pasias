...
<img src="11-tidying-and-selecting-data_files/figure-html/unnamed-chunk-28-1.png" width="672"  />
...
<img src="11-tidying-and-selecting-data_files/figure-html/unnamed-chunk-36-1.png" width="672"  />
...
<img src="11-tidying-and-selecting-data_files/figure-html/unnamed-chunk-53-1.png" width="672"  />
...
## ℹ NAs introduced by coercion
## ℹ Input `..1` is `across(c(temperature, pulse_rate), ~as.numeric(.))`.
```
...
## Warning: Problem with `mutate()` input `..1`.
## ℹ NAs introduced by coercion
## ℹ Input `..1` is `across(2:3, ~as.numeric(.))`.
```
