...
##   sex   pain.type resting.bp serum.chol
##   <chr> <chr>          <dbl>      <dbl>
## 1 male  typical          120        280
## 2 male  typical          120        280
## 3 fema~ typical          120        213
## 4 male  asymptom~        140        280
## 5 male  atypical         140        213
## 6 male  nonangin~        120        213
## 7 fema~ nonangin~        140        280
## 8 male  asymptom~        120        213
