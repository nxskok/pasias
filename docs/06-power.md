...
(b)\label{part:type-i} Estimate by simulation the power of a $t$-test to reject a
...
distribution, (ii) run the $t$-test with the required null mean,
...
(d)\label{part:type-ii} By copying, pasting and editing your code from the previous
