...
`r tufte::margin_note("Mine is rather  prosaically called *Downloads*.")` 
...
`r tufte::margin_note("Let me know if you  have more success than I did.")` 
...
you.
`r tufte::margin_note("A Word or Excel document has all kinds of formatting  information hidden in the file as well as the text that you see on  the screen.")`  
...
the $x$ would be.
`r tufte::margin_note("You might have a second categorical variable  by which you want to arrange the facets left and right, and that  would go where the dot is.")`
...
code:
`r tufte::margin_note("I took out the *ncol* since that confuses the  explanation here.")` 
...
`r tufte::margin_note("Google defines this as            meaning *outstandingly bad, shocking*.")` So I think we
