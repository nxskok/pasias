##  What distinguishes people who do different jobs?
 ...
 244
`r tufte::margin_note("Grammatically, I am supposed to write this as  *two hundred and forty-four* in words, since I am not supposed to  start a sentence with a number. But, I say, deal with it. Or, I  suppose, *there are 244 people who work...*.")` people work at a
certain company. 
...
`r tufte::margin_note("Until much later.")`
...
`r tufte::margin_note("I  discovered that I used *pp* twice, and I want to use the first one again later, so I had to rename this one.")`
...
`r tufte::margin_note("So we should do it, when assessing how good the classification is.")`
