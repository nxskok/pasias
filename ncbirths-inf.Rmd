...
that the mean is less: $H_a: \mu<7.3$ pounds.\endnote{I
surreptitiously defined $\mu$ before using it, but you could start
with something like \emph{let $\mu$ be the mean weight of all babies
born in North Carolina}, and then use $\mu$ in your hypotheses,
which would be clearer in all honesty.}
This is a one-sided
